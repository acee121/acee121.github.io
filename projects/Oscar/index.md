...
这里记录了我每年的观影中自认为演绎得最棒的角色。他们不一定是各大奖项的赢家，但一定是在某个瞬间，深深触动我内心的那一个。
...
<div style="text-align: center; margin: 20px 0;">
    <img src="{{ 'projects/Oscar/img/2023-f-01.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
    <img src="{{ 'projects/Oscar/img/2023-f-02.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
    <img src="{{ 'projects/Oscar/img/2023-f-03.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
    <img src="{{ 'projects/Oscar/img/2023-f-04.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
</div>
...
<div style="text-align: center; margin: 20px 0;">
    ...
    <img src="{{ 'projects/Oscar/img/2023-m-02.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
    <img src="{{ 'projects/Oscar/img/2023-m-03.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
    <img src="{{ 'projects/Oscar/img/2023-m-04.jpg' | relative_url }}" alt="剧照" style="max-width: 45%; margin: 5px; border-radius: 5px;" />
</div>
